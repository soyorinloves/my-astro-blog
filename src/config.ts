...
export const siteConfig: SiteConfig = {
	title: "Soyonu",
	subtitle: "Keep Learning Keep Creating",
	...
	bilibili: {
		vmid: "522562597", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Soyonuの房间", // 主页横幅主标题

			subtitle: [
				"愿明天，也是能和你一起笑着度过的日子",
				"风捎来的季节声响，想和你一起聆听",
				"今天也是平平无奇的一天，但好像，也还不错",
				"那些不经意的闲聊，都是我的珍宝",
				"没什么特别的事，但只要有你在就足够了",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/soyorinloves",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/522562597",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Pixiv",
					url: "https://www.pixiv.net/users/78570737",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到博客！这里会更新我的学习与日常", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		home: "点击这里返回首页，好吗？", // 首页提示
		skin: ["你... 想看我的新造型吗？", "我... 希望它适合我..."], // 换装提示
		close: "感谢你的来访... 下次再见...", // 关闭提示
		link: "https://space.bilibili.com/522562597", // 关于链接
	},
};
